...
if not module_exists("numpy"):
    print("You need module 'numpy' to be installed in your python")
    exit(1)
else:
    import numpy as np
if not module_exists("pandas"):
    print("You need module 'pandas' to be installed in your python")
    exit(1)
else:
    import pandas as pd
if not module_exists("math"):
    print("You need module 'math' to be installed in your python")
    exit(1)

if not module_exists("sklearn"):
    print("You need module 'sklearn' to be installed in your python")
    exit(1)
else:
    from sklearn.metrics import mean_squared_error

if not module_exists("scipy"):
    print("You need module 'scipy' to be installed in your python")
    exit(1)
else:
    from scipy.optimize import curve_fit
    from scipy.optimize import fsolve

if not module_exists("datetime"):
    print("You need module 'datetime' to be installed in your python")
    exit(1)
else:
    from datetime import datetime,timedelta
